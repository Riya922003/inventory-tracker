...
const quickActions = [
  { name: "Add Product", icon: FaPlus, action: "add-product" },
  { name: "Import CSV", icon: FaFileImport, action: "import" },
  { name: "Invite Team", icon: FaUsers, action: "invite" },
];
      ...
      <aside className="w-64 bg-gradient-to-b from-indigo-900 via-indigo-800 to-indigo-900 text-white flex flex-col">
        ...
        <div className="px-3 py-4 border-t border-indigo-700">
          <div className="flex items-center gap-3 px-4 py-3 rounded-lg bg-indigo-800">
            <div className="w-8 h-8 bg-purple-500 rounded-full flex items-center justify-center font-semibold">
              A
            </div>
