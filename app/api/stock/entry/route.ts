...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    // Warehouse managers can only add stock to their assigned warehouses (PostgreSQL check)
...
export async function GET(req: NextRequest) {
  try {
    ...
    // Warehouse managers can only see stock in their assigned warehouses (PostgreSQL check)
    if (user.role === "warehouse_manager") {
