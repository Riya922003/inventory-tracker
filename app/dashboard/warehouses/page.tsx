...
export default function WarehousesPage() {
  ...
  const getUtilizationColor = (u: number) => {
    ...
    if (u >= 70) return "bg-orange-500";
    if (u >= 50) return "bg-yellow-500";
    return "bg-green-500";
  };

  const getUtilizationStatus = (u: number) => {
    if (u >= 90) return { text: "Critical Capacity", icon: FaExclamationTriangle, color: "text-red-600 dark:text-red-400" };
    if (u >= 70) return { text: "High Occupancy", icon: FaExclamationTriangle, color: "text-orange-600 dark:text-orange-400" };
    return { text: "Active", icon: FaCheckCircle, color: "text-green-600 dark:text-green-400" };
  };
    ...
    <div className="p-8">
      ...
      <div className="flex justify-between items-start mb-8">
        ...
        <Button
          ...
          className="bg-indigo-600 hover:bg-indigo-700 dark:bg-cyan-500 dark:hover:bg-cyan-400 dark:text-gray-950"
        >
      ...
      {warehouses.length === 0 ? (
        <Card>
          <CardContent className="py-12 text-center">
            <FaWarehouse className="mx-auto text-6xl text-gray-300 dark:text-gray-600 mb-4" />
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2">
                      <div className="flex items-start gap-4">
                        <div className="p-3 bg-indigo-100 dark:bg-cyan-500/10 rounded-lg flex-shrink-0">
                          <FaWarehouse className="text-2xl text-indigo-600 dark:text-cyan-400" />
                        </div>
                        <div className="flex-1">
                          ...
                          <div className="bg-gray-50 dark:bg-white/5 rounded-lg p-4">
                            <div className="flex items-center gap-2 mb-3">
                              <FaChartBar className="text-indigo-600 dark:text-cyan-400" />
                            ...
                            <div className="grid grid-cols-3 gap-4 text-sm">
                              <div>
                                <p className="text-gray-600 dark:text-gray-400">Health Status</p>
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <div className="w-full bg-gray-200 dark:bg-white/10 rounded-full h-3 overflow-hidden">
                          <div
                            className={`h-full ${getUtilizationColor(warehouse.metrics.utilization)} transition-all duration-300`}
